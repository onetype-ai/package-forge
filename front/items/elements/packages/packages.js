        ...
        return /* html */ `
            <div class="box ot-scrollbar">
                <div class="ot-container-m">
                    <e-admin-global-heading title="Forge" description="Packages registered for development. Open one to talk to Forge and watch it work."></e-admin-global-heading>

                    <div class="form">
                        <e-admin-form-input :value="slug" placeholder="Slug, letters and numbers only" :_input="slugInput"></e-admin-form-input>
                        <e-admin-form-input :value="name" placeholder="Name" :_input="nameInput"></e-admin-form-input>
                        <e-admin-form-input :value="description" placeholder="Description" :_input="descriptionInput"></e-admin-form-input>
                        <e-admin-form-button icon="add" text="Register" :disabled="!slug || !name || saving" :_click="() => create()"></e-admin-form-button>
                    </div>
